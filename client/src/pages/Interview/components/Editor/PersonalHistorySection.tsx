...
const PersonalHistorySection: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (smokingHistory !== autoGenerated) {
      ...
      console.log('[PersonalHistorySection] 检测到用户手动修改吸烟史', { current: smokingHistory, autoGenerated });
    }
  ...
  useEffect(() => {
    ...
    if ((alcoholStatus === '饮酒' || alcoholStatus === '已戒酒') && drinkVolume && alcoholDegree) {
        ...
        autoGenerated += `，每次${drinkVolume}ml (${alcoholDegree}%)，折合酒精量 ${grams}g${weekly ? `；每周约 ${weekly}g` : ''}。`;
    ...
    if (drinkingHistory !== autoGenerated) {
      ...
      console.log('[PersonalHistorySection] 检测到用户手动修改饮酒史', { current: drinkingHistory, autoGenerated });
    }
  ...
  useEffect(() => {
    ...
    if (result) {
        ...
        if (smokingChanged && !userModifiedSmokingRef.current && (!prevText || prevText === '')) {
          ...
          console.log('[PersonalHistorySection] 自动生成吸烟史', result);
        }
        if (prevIndex !== index) {
  ...
  useEffect(() => {
    ...
    if (result) {
        ...
        if (drinkingChanged && !userModifiedDrinkingRef.current) {
          ...
          console.log('[PersonalHistorySection] 自动生成饮酒史', result);
        }
