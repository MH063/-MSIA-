...
const PersonalHistorySection: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (personalOccupation && personalOccupation !== generalOccupation) {
      ...
      logger.info('[PersonalHistorySection] 同步职业到一般项目', personalOccupation);
    }
  ...
  useEffect(() => {
    ...
    if (personalEmployer && personalEmployer !== generalEmployer) {
      ...
      logger.info('[PersonalHistorySection] 同步工作单位到一般项目', personalEmployer);
    }
  ...
  useEffect(() => {
    ...
    if (personalBirthplace && personalBirthplace !== generalPlaceOfBirth) {
      ...
      logger.info('[PersonalHistorySection] 同步出生地到一般项目', personalBirthplace);
    }
  ...
  useEffect(() => {
    ...
    if (smokingHistory !== autoGenerated) {
      ...
      logger.info('[PersonalHistorySection] 检测到用户手动修改吸烟史', { current: smokingHistory, autoGenerated });
    }
  ...
  useEffect(() => {
    ...
    if (drinkingHistory !== autoGenerated) {
      ...
      logger.info('[PersonalHistorySection] 检测到用户手动修改饮酒史', { current: drinkingHistory, autoGenerated });
    }
  ...
  useEffect(() => {
    ...
    if (result) {
        ...
        if (smokingChanged && !userModifiedSmokingRef.current && (!prevText || prevText === '')) {
          ...
          logger.info('[PersonalHistorySection] 自动生成吸烟史', result);
        }
        if (prevIndex !== index) {
  ...
  useEffect(() => {
    ...
    if (result) {
        ...
        if (drinkingChanged && !userModifiedDrinkingRef.current) {
          ...
          logger.info('[PersonalHistorySection] 自动生成饮酒史', result);
        }
