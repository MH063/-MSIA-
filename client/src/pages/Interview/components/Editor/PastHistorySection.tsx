      ...
      <Card type="inner" title="【疾病史】" size="small" style={{ marginBottom: 24 }}>
         ...
         {selectedDiseases.map((d: string) => (
             <div key={d} style={{ marginBottom: 12, background: '#f5f5f5', padding: 8, borderRadius: 4 }}>
                 ...
                 <Space>
                     <InputNumber placeholder="确诊年份" onChange={v => form.setFieldValue(['pastHistory', 'diseaseDetails', d, 'year'], v)} />
                     <Input placeholder="控制情况" onChange={e => form.setFieldValue(['pastHistory', 'diseaseDetails', d, 'control'], e.target.value)} />
                     <Input placeholder="用药情况" onChange={e => form.setFieldValue(['pastHistory', 'diseaseDetails', d, 'medication'], e.target.value)} />
                 </Space>
             </div>
         ))}
